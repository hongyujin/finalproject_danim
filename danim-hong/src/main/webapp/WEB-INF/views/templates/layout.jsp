...
<style type="text/css">
	#main{
		background: url(resources/bootstrap/images/DSC08926.jpg) no-repeat center fixed;
...
#owl1 .owl-prev, #owl1 .owl-next {
	cursor: pointer;
	position: absolute;
	/* background: url(${initParam.root}images/prevnext-1.png); */
	...
	.card-receep-header { border-bottom: 1px solid #e9ecf0; border-top: 1px solid #e9ecf0;}
	.card-receep-header .username { color: #004080; font-weight: bold; }
	.card-receep-header .timeago { color: #c7cbd1; font-size: 12px; }		
	.card-receep-header #like { color: #8a8f96; }		
	.card-receep-header #like:hover { color: #ff0080; }
	.card-receep-entry { background-size: 33px 34px; position: relative; }
